...
stopword_path = "pybin/jieba_dict/stop_words.txt"
jieba_dict_path = "pybin/jieba_dict/dict.txt.big.txt"
jieba.analyse.set_stop_words("pybin/jieba_dict/stop_words.txt")
stopWords = []
