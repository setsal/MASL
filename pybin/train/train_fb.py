...
def main():
    ...
    #filt_list = [[y for y in x if y in {'FGO','fgo','少女前線','白貓','寫真','cosplay','cos','東方','演唱會','百合','艦娘','血小板','碧藍','偶像','音樂','工作細胞'}] for x in seg_list]
    ...
    for doc in seg_list:
        for word in doc:
            if word in ['FGO','fgo','少女前線','白貓','寫真','cosplay','cos','東方','演唱會','百合','艦娘','血小板','碧藍','偶像','音樂','工作細胞']:
